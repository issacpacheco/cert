...
if (isset($_POST['alta']))
{
	mysqli_query($conexion,"ALTER TABLE extras AUTO_INCREMENT = 0");
	mysqli_query($conexion, "INSERT INTO extras VALUES (
	'0', 
	'" . $_POST[ 'nombre' ] . "',
	'" .$_POST['contenido']. "'
	)" );
...
{
	mysqli_query($conexion,"UPDATE extras SET 
		nombre = '".$_POST['nombre']."',
...
{
	mysqli_query($conexion,"DELETE FROM extras WHERE id = '".$_POST['eliminar']."' LIMIT 1");
}
?>
<!DOCTYPE html>
<html lang="es">
                ...
                <div class="col-sm-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<form action="extras_abc" method="post">
                            ...
                            <div>
                                <table class="table table-striped table-bordered table-hover" id="tabla">
                                    ...
                                    <tbody>
										<?php
										$consulta = mysqli_query($conexion,"SELECT * FROM extras");
					   ...
					   "language": { url:"//cdn.datatables.net/plug-ins/1.10.19/i18n/Spanish.json"},
						...
						buttons: [
							...
							},
							{
								...
								messageTop: 'Información complementaria',
								footer: true
							},
							{
								extend: 'print',
