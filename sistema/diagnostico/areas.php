...
if (isset($_POST['alta']))
{
	mysqli_query($conexion,"ALTER TABLE areas AUTO_INCREMENT = 0");
	mysqli_query($conexion, "INSERT INTO areas VALUES (
	'0', 
	'" . $_POST[ 'nombre' ] . "'
	)" );
}
...
{
	mysqli_query($conexion,"UPDATE areas SET 
		nombre = '".$_POST['nombre']."'
		WHERE id = '".$_POST['editar']."' LIMIT 1");
}
if (isset($_POST['eliminar']))
{
	mysqli_query($conexion,"DELETE FROM areas WHERE id = '".$_POST['eliminar']."' LIMIT 1");
}
?>
<!DOCTYPE html>
<html lang="es">
                ...
                <div class="col-sm-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<form action="areas_abc" method="post">
											...
											<tr class="odd">
												...
												<td>
													<form action="reactivos" method="post">
														<input type="hidden" name="id_area" value="'.$d['id'].'">
														<button type="submit" class="btn btn-md btn-info btn-block"><i class="fa fa-question-circle"></i> Reactivos</button>
													</form>
												</td>
												<td>
													<form action="areas_abc" method="post">
