							...
							<table class="table table-striped table-bordered table-hover nowrap" id="tabla">
								<thead>
									<tr>
										...
										<th data-priority="8"> <i class="fa fa-trash"></i> </th>
										<th data-priority="5"> <i class="fa fa-print"></i> </th>
										<th data-priority="6"> <i class="fa fa-pencil-square-o"></i> </th>
								...
								while ($d = mysqli_fetch_array($consulta))
								{
									...
									$consulta2 = mysqli_query($conexion2,"SELECT * FROM aspirantes_validacion WHERE id_aspirante = '".$d['id']."' AND presentado_d = '1'");
									...
									if ($class=='success')
									{
										...
										<td>
											<form action="imprimir" method="post" target="_blank">
												<input type="hidden" name="id" value="'.$d['id'].'">
												<button type="submit" class="btn btn-md btn-info btn-block" data-toggle="tooltip" data-placement="top" title="Imprimir constancia"><i class="fa fa-print"></i> Imprimir</button>
											</form>
										</td>
										<td>
										<form action="aspirantes_resultados" method="post" target="_blank">
												<input type="hidden" name="id" value="'.$d['id'].'">
												<button type="submit" class="btn btn-md btn-warning btn-block" data-toggle="tooltip" data-placement="top" title="Resultados del examen"><i class="fa fa-pencil-square-o"></i> Resultados</button>
											</form>
										</td>
										<td>
