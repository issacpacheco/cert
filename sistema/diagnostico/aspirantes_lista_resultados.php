                        ...
                        <div class="panel-body">
							<div>
                                <table class="table table-striped table-bordered table-hover nowrap" id="tabla">
									...
									{	
										$c++;
										$consulta1 = mysqli_query($conexion,"SELECT * FROM examen WHERE id_aspirante = '".$d['id']."'");
										$total = mysqli_num_rows($consulta1);

										$consulta1 = mysqli_query($conexion,"SELECT * FROM examen WHERE correcta = '1' AND id_aspirante = '".$d['id']."'");
