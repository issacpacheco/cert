...
{
	$consulta = mysqli_query($conexion,"SELECT * FROM areas WHERE id = '".$_POST['id']."' LIMIT 1");
                ...
                <div class="col-sm-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                        	<form action="areas" method="post" id="form_abc">
								<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<a href="areas" class="btn btn-info btn-lg btn-block">Cancelar <i class="fa fa-close"></i></a>
									</div>
								</div>
                            </form>
                        </div>
