                ...
                <div class="col-sm-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                        	<form action="usuarios" method="post" id="form_abc">
								<div class="row">
									...
									<div class="form-wrapper col-sm-6">
										...
										<div class="form-group ">
											<select name="nivel" id="nivel" class="form-control">
												...
												?>
												<option value="1" <?php echo $selected1.' '.$disabled;?>>Super Administrador</option>
												<option value="3" <?php echo $selected2.' '.$disabled;?>>Administrador</option>
												<option value="4" <?php echo $selected3.' '.$disabled;?>>Usuario</option>
											</select>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="form-wrapper col-sm-6">
										...
										<div class="form-group ">
											<input type="text" class="form-control" name="usuario" id="usuario" placeholder="Usuario" value="<?php echo $d['usuario'];?>" <?php echo $read;?>>
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<a href="usuarios" class="btn btn-info btn-lg btn-block">Cancelar <i class="fa fa-close"></i></a>
									</div>
								</div>
                            </form>
                        </div>
