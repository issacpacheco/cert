...
if (isset($_POST['alta']))
{
	mysqli_query($conexion,"ALTER TABLE factores AUTO_INCREMENT = 0");
	mysqli_query($conexion, "INSERT INTO factores VALUES (
	'0', 
	'" . $_POST[ 'id_dimension' ]  . "',
	'" . $_POST[ 'nombre' ] . "',
	'" . $_POST[ 'descripcion' ] . "'
...
{
	mysqli_query($conexion,"UPDATE factores SET 
...
{
	mysqli_query($conexion,"DELETE FROM factores WHERE id = '".$_POST['eliminar']."' LIMIT 1");
}
?>
<!DOCTYPE html>
<html lang="es">
                ...
                <div class="col-sm-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<form action="factores_abc" method="post">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tabla">
                                    ...
                                    <tbody>
										<?php
										$consulta = mysqli_query($conexion,"SELECT * FROM factores");
										while ($d = mysqli_fetch_array($consulta))
										{
											$consulta_dimension = mysqli_query($conexion,"SELECT * FROM dimensiones WHERE id = '".$d['id_dimension']."' LIMIT 1");
											$dimension = mysqli_fetch_array($consulta_dimension);
											
											echo '
											<tr class="odd">
												<td>'.$d['nombre'].'</td>
												<td>'.$dimension['nombre'].'</td>
												<td>'.($d['tipo']==1?'Positivo':'Negativo').'</td>
												<td>
													<form action="factores_abc" method="post">
