...
{
	$consulta = mysqli_query($conexion,"SELECT * FROM factores WHERE id = '".$_POST['id']."' LIMIT 1");
                ...
                <div class="col-sm-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                        	<form action="factores" method="post" id="form_abc">
								<div class="row">
									...
									<div class="form-wrapper col-sm-4">
										...
										<div class="form-group">
											<select class="form-control" name="id_dimension" id="id_dimension" <?php echo $disabled;?>>
												<option value="">Seleccionar</option>
												<?php 
												$consulta_tipo = mysqli_query($conexion,"SELECT * FROM dimensiones");
												while ($tipo = mysqli_fetch_array($consulta_tipo))
												{
													if ($d['id_dimension'] == $tipo['id'])
													{
								...
								<div class="row">
									<div class="form-wrapper col-sm-12">
										...
										<div class="form-group">
											<textarea name="descripcion" class="form-control" rows="5" placeholder="Descripción" <?php echo $read;?>><?php echo $d['descripcion'];?></textarea>
										</div>
									</div>									
								</div>
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<a href="factores" class="btn btn-info btn-lg btn-block">Cancelar <i class="fa fa-close"></i></a>
									</div>
								</div>
                            </form>
                        </div>
