...
if (isset($_POST['editar']))
{
	mysqli_query($conexion,"UPDATE reactivos SET 
		...
		reactivo_h = '" . $_POST[ 'reactivo_h' ] . "',
		reactivo_m = '" . $_POST[ 'reactivo_m' ] . "',
		tipo = '" . $_POST[ 'tipo' ] . "',
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tabla">
                                    ...
                                    <tbody>
										<?php
										$consulta = mysqli_query($conexion,"SELECT * FROM reactivos");
										while ($d = mysqli_fetch_array($consulta))
										{
											$consulta_factor = mysqli_query($conexion,"SELECT * FROM factores WHERE id = '".$d['id_factor']."' LIMIT 1");
