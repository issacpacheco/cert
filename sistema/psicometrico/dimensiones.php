...
if (isset($_POST['alta']))
{
	mysqli_query($conexion,"ALTER TABLE dimensiones AUTO_INCREMENT = 0");
	mysqli_query($conexion, "INSERT INTO dimensiones VALUES (
	'0', 
	'" . $_POST[ 'id_tipo' ]  . "',
	'" . $_POST[ 'nombre' ] . "',
	'" . $_POST[ 'verde' ] . "',
...
{
	mysqli_query($conexion,"UPDATE dimensiones SET 
...
{
	mysqli_query($conexion,"DELETE FROM dimensiones WHERE id = '".$_POST['eliminar']."' LIMIT 1");
}
?>
<!DOCTYPE html>
<html lang="es">
                ...
                <div class="col-sm-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<form action="dimensiones_abc" method="post">
										<button type="submit" class="btn btn-success btn-lg btn-block"><i class="fa fa-plus"></i> Nueva </button>
									</form>
								</div>
							</div>
							<br>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tabla">
                                    ...
                                    <tbody>
										<?php
										$consulta = mysqli_query($conexion,"SELECT * FROM dimensiones");
										while ($d = mysqli_fetch_array($consulta))
										{
											$consulta_tipo = mysqli_query($conexion,"SELECT * FROM dimensiones_tipo WHERE id = '".$d['id_tipo']."' LIMIT 1");
