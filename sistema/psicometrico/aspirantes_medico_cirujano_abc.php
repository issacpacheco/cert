                ...
                <div class="col-sm-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                        	<form action="aspirantes_medico_cirujano" method="post" id="form_abc" enctype="multipart/form-data">
								<div class="row">
								...
								<div class="row">		
									...
									<div class="form-wrapper col-sm-4">
										<label>Folio</label>
										<div class="form-group ">
											<input type="text" class="form-control" name="folio" placeholder="Folio" value="<?php echo $d['folio'];?>" <?php echo $read;?>>
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<a href="aspirantes_medico_cirujano" class="btn btn-info btn-lg btn-block">Cancelar <i class="fa fa-close"></i></a>
									</div>
								</div>
                            </form>
                        </div>
