                ...
                <div class="col-sm-12">
                    <div class="panel">
                        <div class="panel-heading">
                            Aspirantes Completos
							<div class="row">
								<div class="col-lg-12">							
									<p class="text-success">Marcador verde: Exámenes presentados, en espera de validación.</p>
								</div>
							</div>
                        </div>
                        <div class="panel-body">
							<table class="table table-striped table-bordered table-hover nowrap" id="tabla">
								...
								while ($d = mysqli_fetch_array($consulta))
								{
									...
									{
										$consulta1 = mysqli_query($conexion2,"SELECT * FROM aspirantes_validacion WHERE id_aspirante = '".$d['id']."' AND (presentado_d = '0' OR presentado_p = '0')");
									...
									if ($d['id_oferta']==22 || $d['id_oferta']=='3' || $d['id_oferta']=='4' || $d['id_oferta']=='19')
									{
										$consulta1 = mysqli_query($conexion2,"SELECT * FROM aspirantes_validacion WHERE id_aspirante = '".$d['id']."' AND presentado_p = '0'");
										if (mysqli_num_rows($consulta1)>0)
										{
											continue;
										}
									...
									{
										$btn_validar = '<td><h3>Aspirante validado</h3></td>';
										continue;
									}
									else
									{
										$btn_validar = '<td>
											<form action="aspirantes_completos" method="post">
