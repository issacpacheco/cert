                ...
                <div class="col-sm-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                        	<form action="reactivos" method="post" id="form_abc">
								<div class="row">
									<div class="form-wrapper col-sm-4">
										<label>Factor</label>
										<div class="form-group">
											<select class="form-control" name="id_factor" id="id_factor" <?php echo $disabled;?>>
												<option value="">Seleccionar</option>
												<?php 
												$consulta_tipo = mysqli_query($conexion,"SELECT * FROM factores");
												while ($tipo = mysqli_fetch_array($consulta_tipo))
												{
													if ($d['id_factor'] == $tipo['id'])
													{
									...
									<div class="form-wrapper col-sm-4">
										<label>Tipo</label>
										<div class="form-group">
											<select class="form-control" name="tipo" id="tipo" <?php echo $disabled;?>>
												<?php 
												if ($d['tipo']==-1)
												{
													echo '
									...
									<div class="form-wrapper col-sm-4">
										<label>Peligro</label>
										<div class="form-group">
											<select class="form-control" name="peligro" id="peligro" <?php echo $disabled;?>>
												<?php 
												if ($d['tipo']==-1)
												{
													echo '
								...
								<div class="row">
									<div class="form-wrapper col-sm-12">
										<label>Reactivo (Masculino)</label>
										<div class="form-group has-success has-feedback">
											<textarea name="reactivo_h" class="form-control" rows="4" placeholder="Reactivo para genero masculino" <?php echo $read;?>><?php echo $d['reactivo_h'];?></textarea>
										</div>
									</div>									
								</div>
								...
								<div class="row">
									<div class="form-wrapper col-sm-12">
										<label>Reactivo (Femenino)</label>
										<div class="form-group has-warning has-feedback">
											<textarea name="reactivo_m" class="form-control" rows="4" placeholder="Reactivo para genero femenino" <?php echo $read;?>><?php echo $d['reactivo_m'];?></textarea>
										</div>
									</div>									
								</div>
