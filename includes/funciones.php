                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
							...
							<a title="Familia CERT" href="http://cert.edu.mx/ver?token=docs&recurso=PRESENTACION_CERT.pdf" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #000;">Familia CERT</a>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 18px;">
                                <a class="mcnButton " title="Agenda tu examen diagnóstico " href="http://cert.edu.mx/admisiones/perfil" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Ingresa al perfil de aspirante</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
							...
							<div style="text-align: left;">
								<font face="merriweather, georgia, times new roman, serif">
									<span style="font-size:16px">RECUERDA QUE PARA LA TOMA DE LA FOTOGRAFÍA DE TU CREDENCIAL DEBERÁS CUMPLIR LOS SIGUIENTES LINEAMIENTOS:
									<br>
									<br>
										• Ropa formal (blusa o camisa de vestir de preferencia color blanco) <br>
										• Cabello presentable <br>
										• Cara descubierta (no piercing en el rostro) <br>
										• Maquillaje natural <br>
										<br>
										*En caso de incumplir con estas especificaciones obligatorias, no será posible procesar su credencial cuando tenga la calidad de alumno universitario.
									</span>
								</font>
            ...
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 4px;background-color: #2E9B9B;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 18px;">
                                <a class="mcnButton " title="Mi perfil" href="http://cert.edu.mx/admisiones/perfil" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Mi perfil</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
